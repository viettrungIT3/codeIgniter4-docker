...
class Accounts extends Seeder
{
    public function run()
    {
        ...
        $existingAccount = $accounts->where('Username', env('default.login.admin.username'))->first();
        ...
        if ($existingAccount === null) {
            ...
            echo "Username '" . env('default.login.admin.username') . "' already exists. Skipping seeding.";
        }
    }
}
